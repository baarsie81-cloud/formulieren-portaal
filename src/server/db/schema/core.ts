...
export const organizations = pgTable(
  "organizations",
  {
    ...
    signaturePngBlobKey: text("signature_png_blob_key"),
    signaturePngSha256: text("signature_png_sha256"),
    signatureSignerName: text("signature_signer_name"),
    signatureSignerTitle: text("signature_signer_title"),
